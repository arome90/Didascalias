...
public class StudentBehaviour : MonoBehaviour
{
    ...
    {
        _animator.StartTalking();
        if (!onlyMoveMouth && IsSittingOnChair()) _animator.SetStudentBooleanParameter(StudentAnimatorController.HashIsTalkingFront);
    }
