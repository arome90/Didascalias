...
{
    [TaskCategory("Math")]
    [TaskDescription("Checks the climate: less than, less than or equal to, equal to, not equal to, greater than or equal to, or greater than.")]
    public class CheckClimate : Conditional
    {
