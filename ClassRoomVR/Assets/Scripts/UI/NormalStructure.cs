...
namespace ClassRoomVR
{
    ...
    public class NormalStructure : Structure
    {
        ...
        private void InitializeSettings()
        {
            ...
            settings.Columns = Mathf.Min((int)_columnsOption.GetMax(), Mathf.CeilToInt(Mathf.Sqrt(settings.NumDesks)));
        ...
        private void AdjustMatrix()
        {
            ...
            if (settings.NumDesks > totalDesks)
            {
            ...
            {
                if (_columnsOption.GetMin() == settings.Columns || settings.Columns < settings.Rows)
                {
                    settings.Rows--;
                    _rowsOption.SetValue(settings.Rows);
                }
